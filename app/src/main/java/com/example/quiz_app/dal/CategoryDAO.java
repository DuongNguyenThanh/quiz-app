...
public class CategoryDAO {
    ...
    public void createInitialData() {
        ...
        db.execSQL("INSERT INTO " + SQLiteHelper.TABLE_CATEGORY +
                " (name, img_resource) VALUES ('Mathematics', 'https://cdn-icons-png.flaticon.com/512/9503/9503335.png')");
        db.execSQL("INSERT INTO " + SQLiteHelper.TABLE_CATEGORY +
                " (name, img_resource) VALUES ('Language', 'https://cdn-icons-png.flaticon.com/512/3898/3898082.png')");
        db.execSQL("INSERT INTO " + SQLiteHelper.TABLE_CATEGORY +
                " (name, img_resource) VALUES ('Science', 'https://cdn-icons-png.flaticon.com/512/2497/2497631.png')");
        db.execSQL("INSERT INTO " + SQLiteHelper.TABLE_CATEGORY +
                " (name, img_resource) VALUES ('History', 'https://cdn-icons-png.flaticon.com/512/9019/9019000.png')");
        db.execSQL("INSERT INTO " + SQLiteHelper.TABLE_CATEGORY +
