...
public class DoingAcActivity extends AppCompatActivity implements LearningObjectAdapter.LearningObjectListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doing_ac);
        ...
        doingRecyclerView.setLayoutManager(manager);
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(DoingAcActivity.this, QuizActivity.class);
